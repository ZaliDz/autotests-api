...
from clients.exercises.exercises_schema import ExerciseSchema, UpdateExerciseRequestSchema, UpdateExerciseResponseSchema, GetExercisesResponseSchema
...
@allure.step("Check ger exercise response")
def assert_get_exercise_response(get_exercise_response: GetExerciseResponseSchema, create_exercise_response: CreateExerciseResponseSchema):
    ...
    """
    logger.info("Check ger exercise response")
...
def assert_exercise_not_found_response(actual: InternalErrorResponseSchema):
    """
    Проверяет, что тело ответа получения задания содержит внутреннюю ошибку.
